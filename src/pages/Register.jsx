      ...
      <div className="container mx-auto w-96">
          <div className="flex flex-col gap-5 mt-10 bg-white py-4 px-6 rounded-lg">
            ...
            <div className="border-t-2 border-gray-300">
              <p className='text-center mt-2 text-gray-500' style={{fontSize: '9px'}}>By lobby the button above, you agree to our <NavLink className="underline">Terms of Service</NavLink> and <NavLink className="underline">Privacy Policy</NavLink>.</p>
            </div>
          </div>
      </div>
    </>
